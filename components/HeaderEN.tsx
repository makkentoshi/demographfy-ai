...
const components: { title: string; href: string; description: string }[] = [
  {
    ...
    description:
      "How Gemini AI is integrated into the project and what capabilities it provides.",
  },
  {
    title: "Statistics and Data Analysis",
    href: "/docs/primitives/hover-card",
    description: "Using Gemini AI as a data and statistics analyzer.",
  },
  {
    title: "Data Modeling",
    href: "/docs/primitives/progress",
    description: "Data modeling with GoogleGenerativeAI and Recharts.",
  },
  {
    title: "Data Sources and Forecasting",
    href: "/docs/primitives/scroll-area",
    description: "Using the WorldBank API and data forecasting.",
  },
];
                ...
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                      ...
                      <NavigationMenuLink asChild>
                        ...
                        >
                          ...
                          <p className="text-sm leading-tight text-muted-foreground">
                            A website for forecasting, statistics, and analysis
                            of demographic processes in the Republic of
                            Kazakhstan using Gemini AI.
                          </p>
                        </a>
                      </NavigationMenuLink>
                    </li>
                    <ListItem href="/docs" title="Информация">
                      General information about the project and analysis of
                    ...
                    <ListItem
                      ...
                      title="Подробнее..."
                    >
                      About the creator and the project.
                    </ListItem>
                  </ul>
                </NavigationMenuContent>
              </NavigationMenuItem>
